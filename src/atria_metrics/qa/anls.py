...
from atria_metrics.qa.output_transforms import _anls_output_transform
from atria_metrics.registry import METRIC


@METRIC.register("anls", output_transform=_anls_output_transform)
class ANLS(Metric):
    def __init__(
    ...
    def update(self, output):
        ...
        for prediction, gold_labels in zip(
            pred_answers_batch, target_answers_batch, strict=True
        ):
            anls = anls_score(
